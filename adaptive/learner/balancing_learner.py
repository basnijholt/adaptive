...
class BalancingLearner(BaseLearner):
    ...
    def plot(self, cdims=None, plotter=None):
        ...
        cdims : sequence of dicts or a tuple with (keys, list of tuples).
            Constant dimensions. The parameters that distinguish the learners.
            This will generate a `holoviews.DynamicMap` with labeled sliders.
            ...
            - sequence of dicts:
                >>> cdims = [{'A': True, 'B': 0},
                             ...
                             {'A': False, 'B': 0},
                             {'A': False, 'B': 1}]`
            - tuple with (keys, iterable of tuples):
        ...
        dm : holoviews.DynamicMap object
            A DynamicMap with sliders that are defined by the `cdims`.
        """
        hv = ensure_holoviews()
